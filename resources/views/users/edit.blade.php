                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : ' has-success' }}">
                      <input class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" pattern="[a-zA-Z][a-zA-Z ]{1,}" name="firstname" id="input-firstname" type="text" placeholder="{{ __('First Name') }}" value="{{ old('firstname', $user->firstname) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('lastname') ? ' has-danger' : ' has-success' }}">
                      <input class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" pattern="[a-zA-Z][a-zA-Z ]{1,}" name="lastname" id="input-lastname" type="text" placeholder="{{ __('Last Name') }}" value="{{ old('lastname', $user->lastname) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('contact') ? ' has-danger' : ' has-success' }}">
                      <input class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" name="contact" id="input-contact" type="number" placeholder="{{ __('Contact Number') }}" value="{{ old('contact', $user->contact) }}" required="true" aria-required="true"/>
